...
class ProfileScreenLogoutIntegration extends StatefulWidget {
  const ProfileScreenLogoutIntegration({super.key});

  @override
  State<ProfileScreenLogoutIntegration> createState() =>
      _ProfileScreenLogoutIntegrationState();
}

class _ProfileScreenLogoutIntegrationState
    extends State<ProfileScreenLogoutIntegration> {
